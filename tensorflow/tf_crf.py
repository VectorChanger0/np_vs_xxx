...
def tf_crf_score(N0=3, N1=5, N2=7):
    ...
    print('tf_crf_score unary:: np vs tf: ', hfe_r5(np5, tf5_))
    print('tf_crf_score binary:: np vs tf: ', hfe_r5(np6, tf6_))
    print('tf_crf_score log_norm:: np vs tf: ', hfe_r5(np7, tf7_))
    print('tf_crf_score sequence:: np vs tf: ', hfe_r5(np8, tf8_))
    print('tf_crf_score log likelihood:: np vs tf: ', hfe_r5(np9, tf9_))
...
def tf_crf_CrfForwardRnnCell(N0=3, N2=7):
    ...
    with tf.Session() as sess:
        tf4_ = sess.run(tf4)
    print('tf_crf_CrfForwardRnnCell_1:: np vs tf: ', hfe_r5(np4, tf4_))
    print('tf_crf_CrfForwardRnnCell_2:: np vs tf: ', hfe_r5(np5, tf4_))
...
def tf_crf_decode(N0=3, N1=5, N2=7):
    ...
    print('tf_crf_decode path:: np vs tf: ', hfe_r5(np5,tf5_))
    print('tf_crf_decode score:: np vs tf: ', hfe_r5(np6,tf6_))
